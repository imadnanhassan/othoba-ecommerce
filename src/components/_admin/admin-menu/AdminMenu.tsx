  ...
  return (
    <ul className="flex flex-col gap-2">
      ...
      <li id="sidebar">
        <Link
          to="/admin"
          className="flex items-center gap-3 mt-8 px-4 py-2 group relative border-l-4 border-transparent transition-all duration-300 ease-in-out hover:border-[#9559F7] hover:rounded-t-lg hover:rounded-b-lg"
        >
          <DashboardIcon className="transition-colors duration-300 group-hover:text-[#9559F7]" />
      ...
      <li>
        <div
          ...
          className="flex items-center gap-3 px-4 py-2 text-uxSecoundryBg2 dark:text-white group relative border-l-4 border-transparent transition-all duration-300 ease-in-out hover:border-[#9559F7] hover:rounded-t-lg hover:rounded-b-lg cursor-pointer"
        >
          <ReaderIcon className="transition-colors duration-300 group-hover:text-[#9559F7] text-lg" />
      ...
      <li>
        <div
          ...
          className="flex items-center gap-3 px-4 py-2 text-uxSecoundryBg2 dark:text-white group relative border-l-4 border-transparent transition-all duration-300 ease-in-out hover:border-[#9559F7] hover:rounded-t-lg hover:rounded-b-lg cursor-pointer"
        >
          <AvatarIcon className="transition-colors duration-300 group-hover:text-[#9559F7] text-lg" />
      ...
      <li id="sidebar">
        <Link
          to="/admin/signup"
          className="flex items-center gap-3 px-4 py-2 text-uxSecoundryBg2 dark:text-white group relative border-l-4 border-transparent transition-all duration-300 ease-in-out hover:border-[#9559F7] hover:rounded-t-lg hover:rounded-b-lg"
        >
          <GearIcon className="transition-colors duration-300 group-hover:text-[#9559F7]" />
      ...
      <li id="sidebar">
        <Link
          ...
          className="flex items-center gap-3 px-4 py-2 text-uxSecoundryBg2 dark:text-white group relative border-l-4 border-transparent transition-all duration-300 ease-in-out hover:border-[#9559F7] hover:rounded-t-lg hover:rounded-b-lg"
        >
          <ExitIcon className="transition-colors duration-300 group-hover:text-[#9559F7]" />
          <span className="text-sm font-medium text-uxSecoundryBg2 dark:text-white transition-colors duration-300 group-hover:text-uxBgPurpole dark:group-hover:text-uxBgPurpole">
            Logout
          </span>
        </Link>
